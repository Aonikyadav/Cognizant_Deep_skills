...
--             Adds a bonus percentage to salary of all
...
--             Transfers a specified amount from one account
--             to another after checking sufficient balance
-- ============================================================
...
-- Execute Scenario 2: 10% bonus to Department 3
EXEC UpdateEmployeeBonus(3, 10);

-- Execute Scenario 3: Transfer $500 from Account 101 to Account 102
